...
<h5 align="left">A passionate Software Engineer from New York, NY, dedicated to creating and solving complex problems in code since 2021. Currently focused on advanced iOS Development while refining skills in React and TypeScript. The goal is to build scalable and user-friendly applications that make a real impact. For fun, there's a love for playing and designing card games—always on the lookout for elegant solutions, whether in code or in games!</h5>
